...
async function createPaymentIfOnline()
{
    const paymentMethod = localStorage.getItem(PAYMENT_KEY);
    const orderId = sessionStorage.getItem('currentOrderId');

    if(paymentMethod === 'Online')
    {
        const response = await fetch('/kiosk/create-payment', {
            method: 'POST',
